...
# Read in SLR data.
more_sl = pd.read_excel(data_path_2 + "global_basin_timeseries.xlsx", index_col=0)
...
plt.savefig(data_path_6 + "historical_sea_lvl.png", dpi=600, bbox_inches='tight')
...
# 5th quantile.
data_5 = pd.read_csv(data_path_3 + '5_quantile_yearly.csv')
...
print("5th Sea Level Rise Quantile Done")

'''17th Quantile Model'''

# 17th quantile.
data_17 = pd.read_csv(data_path_3 + '17_quantile_yearly.csv')
...
print("17th Sea Level Rise Quantile Done")

'''50th Quantile Model'''

# 50th quantile.
data_50 = pd.read_csv(data_path_3 + '50_quantile_yearly.csv')
...
print("Median Sea Level Rise Quantile Done")


'''83rd Quantile Model'''

# 83rd quantile.
data_83 = pd.read_csv(data_path_3 + '83_quantile_yearly.csv')
...
print("83rd Sea Level Rise Quantile Done")


'''95th Quantile Model'''

# 95th quantile.
data_95 = pd.read_csv(data_path_3 + '95_quantile_yearly.csv')
...
print("95th Sea Level Rise Quantile Done")