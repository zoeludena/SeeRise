...
path_output ='rf_outputs/outputs_ssp245_prediction_ESEm.nc'
...
plt.savefig('rf_outputs/rf_images/rf_tas_comparison.png', dpi=250, bbox_inches="tight")

print("Tas difference plot created")
...
plt.savefig('rf_outputs/rf_images/rf_dtr_comparison.png', dpi=250, bbox_inches="tight")

print("DTR difference plot created")
...
plt.savefig('rf_outputs/rf_images/rf_pr_comparison.png', dpi=250, bbox_inches="tight")

print("PR difference plot created")
...
plt.savefig('rf_outputs/rf_images/rf_pr90_comparison.png', dpi=250, bbox_inches="tight")

print("PR90 difference plot created")
...
fig.tight_layout()
fig.savefig("rf_outputs/rf_images/rf_feature_importances_2x2.png")
...
fig.savefig("rf_outputs/rf_images/rf_feature_importances_grouped.png")
print("Grouped feature importance image created.")